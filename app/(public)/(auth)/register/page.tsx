  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-void px-4">
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute -top-40 -left-40 w-[500px] h-[500px] rounded-full bg-gold/6 blur-[120px]" />
        <div className="absolute -bottom-40 -right-40 w-[400px] h-[400px] rounded-full bg-purple-container/8 blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="font-serif text-3xl text-on-surface mt-6 mb-2">Create Your Account</h1>
          <p className="text-sm text-on-surface-variant tracking-wide">
            Join Emperia to access curated experiences
          </p>
        </div>
        ...
        <div className="bg-surface-container-low rounded-2xl p-8">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-xs text-on-surface-variant mb-1.5 tracking-wide">
                Full Name
              </label>
              <input
                id="name"
        ...
        <p className="text-center mt-6 text-sm text-on-surface-variant">
          ...
          <Link href="/login" className="text-gold hover:text-gold-container transition-colors duration-300">
            Sign in
          </Link>
        </p>
      </div>
